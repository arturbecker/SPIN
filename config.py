...
DATASET_FILES = [ {'h36m-p1': join(DATASET_NPZ_PATH, 'h36m_valid_protocol1.npz'),
                   ...
                   'total-capture': join(DATASET_NPZ_PATH, 'total_capture_validation.npz') # added total capture validation
                  },
                  ...
                  {'h36m': join(DATASET_NPZ_PATH, 'h36m_train.npz'),
				   ...
				   '3dpw': join(DATASET_NPZ_PATH, '3dpw_test.npz'), # Added 3dpw to training datasets
				   'total-capture': join(DATASET_NPZ_PATH, 'total_capture_train.npz') # Added total-capture train .npz
                  }
                ]
...
DATASET_FOLDERS = {'h36m': H36M_ROOT,
		           ...
		           'total-capture': TOTAL_CAPTURE_ROOT # Added total capture image folder
                }
